            ...
            <div class="message" style="height: 231px;">
                <div class="msg">
                    <div class="msg-cell">
                        ...
                        <div class="msg-cell-info special"><?php echo empty($log[0]['version'])? '未提交':$log[0]['version']?></div>
                    </div>
                    <div class="msg-cell">
                ...
                <div class="img" style="padding: 45px 0">
                    <div class="lose-code" data-version_time="<?php echo empty($log[0]['version_time'])?'0':$log[0]['version_time']?>" data-isexpire="<?php echo empty($is_expire)?0:1?>" style="display:<?php echo empty($is_expire)?'none':'block'?>">
