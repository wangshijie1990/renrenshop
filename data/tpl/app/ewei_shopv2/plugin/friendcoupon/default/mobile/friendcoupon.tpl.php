...
<div id="guide"><img src="../addons/ewei_shopv2/plugin/groups/template/mobile/default/images/guide1.png"></div>
    <div class="coupon-carve">
        ...
        <div class="coupon-model" id="tips" style="display:<?php  if($tips) { ?>block<?php  } else { ?>none<?php  } ?>">
            <div class="inner">
                <div class="title">提醒</div>
                <div class="content" id="tips_content"><?php  echo $tips;?></div>
                <div class="btns">
                    <?php  if($mylink) { ?>
                        <a class="btn1 line" href="<?php  echo $mylink;?>">查看我的</a>
                    <?php  } ?>
                    <a class="btn1" href="<?php  echo $back;?>">返回商城</a>
                </div>
        ...
        <div class="header">
            <?php  if(!$isReceive && !$isShare) { ?>
            <!--领取瓜分券-->
            <div class="get">
                <div class="price"><?php  echo $activitySetting['coupon_money'];?><span>元</span></div>
                <img id="receiveActivity" src="../addons/ewei_shopv2/static/images/coupon-get.png">
                <div class="txt">赶快邀请<?php  echo $numberOfInvitations;?>个好友共同瓜分红包吧！</div>
            </div>
            <?php  } else if($isReceive && !$success) { ?>
            <!--瓜分中-->
            <div class="underway share">
                <div class="text">
                    <p class="price" style="margin-top: 0">还差<span><?php  echo $overPeople;?></span>人完成</p>
                    <p class="price">邀请好友一起瓜分<span><?php  echo $activitySetting['coupon_money'];?></span>元</p>
                    <p class="txt">
                ...
                <div class="btns">
                    <a class="btn" href="<?php  echo $back;?>">返回商城</a>
                    <div class="btn invitation">邀请好友瓜分</div>
                </div>
            </div>
            <?php  } else if(!$success && $isShare && !$isReceive) { ?>
            <!--被分享人领取-->
            <div class="share">
                <div class="text">
                    <p class="name">“<?php  echo $share_user['nickname'];?>”</p>
                    <p class="price">邀请你一起瓜分<span><?php  echo $activitySetting['coupon_money'];?></span>元</p>
                    <p class="txt">
                        <span class="countDown">
                            <span class="day">-</span>天
                            <span class="hour">-</span>时
            ...
            <?php  } else if($isReceive && $success) { ?>
            <!--领取成功-->
            <?php  if($coupon && $coupon['used']) { ?><img class="employ" src="../addons/ewei_shopv2/static/images/employ.png" /><?php  } ?>
            <div class="success">
                <div class="text">

                    <p>恭喜您获得</p>
                    <p class="price"><?php  echo $currentActivityInfo['deduct'];?><span>元</span></p>
                    <?php  if($currentActivityInfo['enough'] == 0) { ?>
                    <p class="txt">无门槛使用券</p>
                    <?php  } else { ?>
                    <p class="txt">满<?php  echo $currentActivityInfo['enough'];?>元减<?php  echo $currentActivityInfo['deduct'];?>元优惠券</p>
                    <?php  } ?>

                </div>
                <div class="btns">
                    <a class="btn" href="<?php  echo $back;?>">返回商城</a>
                    <a class="btn" id="use_coupon" <?php  if(!$coupon['used']) { ?>href="<?php  echo mobileUrl('sale.coupon.my.showcoupongoods', array('id'=>$coupon['id'],'mid'=>$coupon['couponid']),true)?>"<?php  } else { ?>onclick="FoxUI.toast.show('优惠券已经使用过了哦');return;"<?php  } ?>>立即使用</a>
                </div>
            </div>
            <?php  } ?>
        </div>
            ...
            <div class="content-card luck-list">
                <div class="inner" id="content">
                    <?php  if(is_array($activityData)) { foreach($activityData as $item) { ?>
                        <div class="item">
                            <img class="adver" src="<?php  echo $item['avatar'];?>">
                            <span class="name" ><?php  echo $item['nickname'];?></span>
                            <?php  if($user['id'] == $activityData[0]['headerid']) { ?>
                            <span id="header" data-id="<?php  echo $user['id'];?>" style="display: none;"></span>
                            <?php  } ?>
                            <span>￥<?php  echo $item['deduct'];?></span>
                        </div>
                    <?php  } } ?>
                    <?php  if($activityDataLen > 5) { ?>
        ...
        <div class="content-card explain">
            <div class="inner">
                ...
                <div class="explain-con">
                    ...
                    <p><span>活动时长：</span><?php  echo $activitySetting['duration'];?>小时</p>
                    <p><span>瓜分人数：</span><?php  echo $activitySetting['people_count'];?>人</p>
                </div>

                <div class="explain-title">瓜分步骤</div>
                <div class="explain-step">
                    <?php  if(is_array($activitySetting['desc'])) { foreach($activitySetting['desc'] as $item) { ?>
                    <p><?php  echo $item;?></p>
                    <?php  } } ?>
                </div>
            </div>
