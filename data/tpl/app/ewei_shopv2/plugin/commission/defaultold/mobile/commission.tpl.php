...
<div class="fui-page fui-page-current page-commission-index ">
	...
	<div class="headinfo">
		...
		<div class='fui-list'>
			...
			<div class='text' ><?php  echo $this->set['texts']['up']?>: <?php  if(empty($up)) { ?>
			    ...
			    <?php  } ?>
				<br>
				<?php  echo $this->set['texts']['icode']?>:<?php  if(p('offic')) { ?><?php  echo $member['mobile'];?><?php  } else { ?><?php  echo $member['id'];?><?php  } ?>
			</div>
		    </div>
		</div>
		<?php  if(empty($this->set['closemyshop'])) { ?>
			<a class="setbtn external" href="<?php  echo mobileUrl('commission/myshop/set')?>"><i class="icon icon-settings"></i></a>
		<?php  } ?>
	    </div>
	    <div class="userblock">
		...
		<div class="line usable">
		    <?php  if($cansettle) { ?>
		    <a class="btn external" href="<?php  echo mobileUrl('commission/withdraw')?>"><?php  echo $this->set['texts']['commission']?><?php  echo $this->set['texts']['withdraw']?></a>
		    <?php  } else { ?>
	...
	<div class="fui-block-group col-3" style='margin-top:0; overflow: hidden;'>
            <a class="fui-block-child external" href="<?php  echo mobileUrl('commission/withdraw')?>">
            ...
            <a class="fui-block-child external" href="<?php  echo mobileUrl('commission/order')?>">
            ...
            <a class="fui-block-child external" href="<?php  echo mobileUrl('commission/log')?>">
		...
		<div class="text"><span><?php  echo number_format($member['applycount'],0)?></span> 笔</div>
            ...
            <a class="fui-block-child external" href="<?php  echo mobileUrl('commission/down')?>">
