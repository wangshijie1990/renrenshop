<?php defined('IN_IA') or exit('Access Denied');?><link href="../addons/ewei_shopv2/plugin/diypage/static/css/plu.min.css?v=20170609" rel="stylesheet" type="text/css"/>
<style type="text/css">.fui-danmu:before {
...
}</style><a class="fui-danmu external <?php echo $danmu['params']['style']==1?'style2':''?>"
            href="<?php echo $danmu['params']['linkurl']?$danmu['params']['linkurl']:'javascript:;'?>"><img class="thumb"
                                                                                                          src="../addons/ewei_shopv2/static/images/nopic100.jpg"/>
    <div class="text">---</div>
