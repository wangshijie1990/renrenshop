...
<!--   <script src="../addons/ewei_shopv2/static/js/dist/foxui/js/foxui.min.js"></script>-->
        ...
        <?php  if(is_h5app()) { ?>
            <style>
                ...
                <?php  if(is_android()) { ?>.head-menu-mask, .fui-mask, .fui-mask-m, .order-list-page .fui-tab {top: 3.2rem;}.head-menu{top: 3.65rem}.diy-fixedsearch{top:3.2rem !important;}<?php  } ?>
              <?php  if(is_ios()) { ?>.diy-fixedsearch{top:2.2rem !important;}<?php  } ?>
            </style>
        <?php  } ?>
