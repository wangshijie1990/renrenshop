<?php defined('IN_IA') or exit('Access Denied');?><script type="text/html" id="account-layer">
    <div class="account-layer" style="height:auto">
        ...
        <div class="account-btn" data-sns="web">登录</div>
		<!--<div class="account-btn" data-sns="wx" style="background-color: #51c332;">微信登录</div>-->
