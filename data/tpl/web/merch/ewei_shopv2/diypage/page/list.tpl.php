...
<div class="page-content">
    ...
    <form action="<?php echo !empty($_W['merchid'])?'./merchant.php':'./index.php'?>" <?php if(mcv('diypage.page.sys.delete|diypage.page.diy.delete|diypage.page.mod.delete')) { ?>method="get"<?php  } ?>>
        ...
        <div class="page-toolbar">
            <div class="col-sm-4">
                <?php  if($pagetype=='mod') { ?>
                    <?php if(mcv('diypage.page.mod.add|diypage.page.mod.add')) { ?>
        ...
        <?php  } else { ?>
            <div class="page-table-header">
                ...
                <div class="btn-group">
                    <?php  if($pagetype=='sys') { ?>
                    <?php if(mcv('diypage.page.sys.delete')) { ?>
                    ...
                    <?php  } ?>
                    <?php  if($pagetype=='diy') { ?>
                    <?php if(mcv('diypage.page.diy.delete')) { ?>
                    ...
                    <?php  } ?>
                    <?php  if($pagetype=='plu') { ?>
                    <?php if(mcv('diypage.page.plu.delete')) { ?>
                    ...
                    <?php  } ?>
                    <?php  if($pagetype=='mod') { ?>
                    <?php if(mcv('diypage.page.mod.delete')) { ?>
                    ...
                    <?php  if(is_array($list)) { foreach($list as $item) { ?>
                        <tr>
                            ...
                            <td>
                                ...
                                <?php  } ?>
                                <?php  if($pagetype=='plu') { ?>
                                    <?php if(mcv('diypage.page.plu.edit')) { ?>
