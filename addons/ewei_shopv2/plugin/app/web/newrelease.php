...
$request = ihttp_post(EWEI_SHOPV2_AUTH_WXAPP . 'generate/upload?id=' , array('version' => $version, 'describe' => $describe, 'tabBar' => $tabBar, 'ticket' => $ticket,'appid' => $appid , 'site_id' => SITE_ID,'uniacid' => $_W['uniacid'], 'appIds' => $appIds));
if ($request['code'] != 200) {
