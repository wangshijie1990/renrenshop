...
class Index_EweiShopV2Page extends PcMobilePage 
{
	...
	public function style($id) 
	{
		switch ($id) 
		{
			...
			case 15: return 'style-red';
			case 16: return "style-pink";
			case 17: return "style-orange";
			case 18: return "style-green";
			case 19: return "style-blue";
			case 20: return "style-purple";	
			default: }
	}
}
