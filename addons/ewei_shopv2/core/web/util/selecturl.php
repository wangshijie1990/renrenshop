        ...
        if ($platform) {
          ...
          $allUrls[0]["list"][] = array('name' => '店铺入口', 'url_wxapp' => '/pages/changce/merch/index');
            ...
            if (cv("commission") && p("commission")) {
                $allUrls[0]["list"][] = array("name" => "分销中心", "url" => mobileUrl("commission", NULL, $full), "url_wxapp" => "/commission/pages/index");
            }
            ...
            if (cv("groups") && p("groups")) {
                $allUrls[0]["list"][] = array("name" => "拼团首页", "url" => mobileUrl("", NULL, $full), "url_wxapp" => "/groups/index/index");
            }
